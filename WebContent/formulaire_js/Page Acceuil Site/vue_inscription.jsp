	...
	<body>
		...
		<!--Menu Principale-->
		    <nav>
		      ...
		      <ul>
		        <li><a class="active" href="https://localhost:44328/LoginMedecinPatient.html">Home</a></li>
		...
		<div class="form">
			...
			<input class="btn" type="submit" name="seconnecter" value="Login">
			...
			<form class="signup-form" action="" method="post">
				...
				<span id="msge"></span> 
				<input class="user-input" type="password" name="Password" id="mdp" placeholder="Mot de passe"  required onblur="checkmdp()" >
				<span id="msg"></span> 
				<input class="btn" type="submit" name="valider" value="S'inscrire">
				<div class="options-02">
